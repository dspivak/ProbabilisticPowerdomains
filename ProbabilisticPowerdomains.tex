...
It is enough to show $P\vee\mu(P\vee Q)\leq P\vee\mu(Q)$. By inclusion-exclusion we have $\mu(P\vee Q)+\mu(P\wedge Q)=\mu(P)+\mu(Q)$ and any modality, including $(P\vee-)$, commutes with addition. Hence it is enough to show $P\vee\mu(P)\leq P\vee\mu(P\wedge Q)$.
...
Semantically, the lower-reals on $\IR$ are order-cancellative in the sense that if $a+b\leq a+c$ then $b\leq c$. We haven't proved this internally.
