...
Note that $\Span\set$ is the topos of sheaves on a topological space $W$ with three points $a,b,ab$ and four open sets: $\emptyset$, $W$, $\{a\}$ and $\{b\}$. The type $\tRR$ corresponds to the constant sheaf, by general theory of real number objects in toposes corresponding to topological spaces.
