...
\end{multline*}
Check that this is a topology and that it is universal. (Unfinished)
\end{proof}

\begin{example}
The functions $+:\tRR_j\times\tRR_j\to\tRR_j$ and $*:\tRR_j\times\tRR_j\to\tRR_j$ are continuous. (Unfinished)
\end{example}
